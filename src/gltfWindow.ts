...
function isIFCFile(editor: vscode.TextEditor | undefined): boolean {
    return editor && editor.document.fileName.toLowerCase().endsWith('.ifc');
}
...
export class GltfWindow {
    ...
    private update() {
        ...
        else if (isIFCFile(vscode.window.activeTextEditor)) {
